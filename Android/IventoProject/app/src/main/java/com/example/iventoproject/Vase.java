...
public class Vase extends AppCompatActivity {
    ...
    private void addModel(Anchor anchor, ModelRenderable modelRenderable) {
        ...
        model.getScaleController().setMaxScale(1.9f);
        model.getScaleController().setMinScale(1.8f);
