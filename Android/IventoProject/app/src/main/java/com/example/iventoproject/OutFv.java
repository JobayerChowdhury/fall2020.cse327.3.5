...
public class OutFv extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_out_fv);
    ...
    private void addModel(Anchor anchor, ModelRenderable modelRenderable) {
        ...
        model.getScaleController().setMaxScale(16f);
        model.getScaleController().setMinScale(15f);
