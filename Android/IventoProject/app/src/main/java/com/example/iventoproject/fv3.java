...
public class fv3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fv3);
    ...
    private void addModel(Anchor anchor, ModelRenderable modelRenderable) {
        ...
        model.getScaleController().setMaxScale(0.0008f);
        model.getScaleController().setMinScale(0.0007f);
